	...
	return (
		<div className="flex w-full items-center justify-between">
			...
			<DropdownMenu>
				...
				<DropdownMenuContent className="flex w-60 gap-2 p-2" align="end">
					<DropdownMenuItem
					...
					>
						<IconRenderer name="LayoutList" className="text-muted-foreground" />
						List
					</DropdownMenuItem>
					<DropdownMenuItem
					...
					>
						<IconRenderer name="LayoutGrid" className="text-muted-foreground" />
						Board
					</DropdownMenuItem>
				</DropdownMenuContent>
			</DropdownMenu>
